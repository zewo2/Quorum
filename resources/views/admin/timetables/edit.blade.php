            ...
            <div class="form-grid">
                ...
                <div class="field-group">
                    <label class="field">
                        ...
                        <input type="time" name="start_time" value="{{ $timetable->start_time->format('H:i') }}" required>
                        @error('start_time')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </label>
                ...
                <div class="field-group">
                    <label class="field">
                        ...
                        <input type="time" name="end_time" value="{{ $timetable->end_time->format('H:i') }}" required>
                        @error('end_time')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </label>
                ...
                <div class="field-group">
                    <label class="field">
                        <span>Room</span>
                        <input type="text" name="room" placeholder="e.g., 101, A-101" value="{{ $timetable->room }}" maxlength="50">
                        @error('room')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </label>
