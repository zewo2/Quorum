...
@section('title', 'Assign Teacher - Quorum')
@section('page-title', 'Assign Teacher to Subject')
...
<div class="form-container">
    ...
    <div class="form-card">
        <form method="POST" action="{{ route('dashboard.admin.teacher-subjects.store') }}" class="stacked-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <select id="teacher_id" name="teacher_id" required class="@error('teacher_id') is-invalid @enderror">
                    ...
                    @foreach($teachers as $teacher)
                        <option value="{{ $teacher->id }}" {{ (int)old('teacher_id') === $teacher->id ? 'selected' : '' }}>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="academic_year" name="academic_year" min="2000" max="2100" value="{{ old('academic_year', now()->year) }}" class="@error('academic_year') is-invalid @enderror">
                    @error('academic_year')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="class_capacity" name="class_capacity" min="1" max="500" value="{{ old('class_capacity', 40) }}" class="@error('class_capacity') is-invalid @enderror">
