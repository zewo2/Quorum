            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        @php
                            $selectedCourseIds = old('course_ids', []);
                        @endphp
                        <details class="courses-dropdown @error('course_ids') is-invalid @enderror" id="courseDropdownCreate">
                            <summary>
                                <span id="courseDropdownCreateLabel">
                    ...
                    <div class="form-group">
                        ...
                        >
                            <option value="1" {{ (int) old('semester', 1) === 1 ? 'selected' : '' }}>1</option>
                            <option value="2" {{ (int) old('semester', 1) === 2 ? 'selected' : '' }}>2</option>
                        </select>
                        @error('semester')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
...
document.addEventListener('DOMContentLoaded', function () {
    const dropdown = document.getElementById('courseDropdownCreate');
    const label = document.getElementById('courseDropdownCreateLabel');
